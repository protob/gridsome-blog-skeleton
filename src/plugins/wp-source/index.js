...
class WordPressSource {
  ...
  createPages(api) {
    ...
    //   typeName: "CityInfo",
    //   route: "/blog/:slug",
    //   component: "./src/templates/WordPressBlog.vue"
    // });
  ...
  async getPostTypes(actions) {
    ...
    for (const type in data) {
      ...
      // this.restBases.posts[type] = options.rest_base; //DTB
  ...
  async getTaxonomies(actions) {
    ...
    for (const type in data) {
      ...
      this.restBases.taxonomies[type] = trimStart(options.rest_base, "/"); //DTB
        ...
        for (const type in this.restBases.taxonomies) {
          ...
          if (post.hasOwnProperty(propName)) {
            ...
            fields[key] = Array.isArray(post[propName])
              ...
              : createReference(typeName, post[propName]); // DTB
          }
        }
